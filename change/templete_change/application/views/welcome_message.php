...
<body class="hold-transition login-page" style="background-image: url('books-in-black-wooden-book-shelf-159711.jpg'); background-size = cover; background-repeat: no-repeat; background-position: center;">
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo base_url() ?>home_body" method="post">
